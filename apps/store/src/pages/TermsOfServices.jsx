...
export default function TermsOfServices() {
  ...
  const sections = [
    ["pages.terms.section1", "pages.terms.section1Text"],
    ["pages.terms.section2", "pages.terms.section2Text"],
    ["pages.terms.section3", "pages.terms.section3Text"],
  ];
    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="bg-black py-20 text-white">
        <div className="site-container">
          ...
          <h1 className="home-hero-title">{t("pages.terms.title")}</h1>
